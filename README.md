...
#### XSS Payload List/Список полезных нагрузок XSS :
...
###### XSS (Cross Site Scripting) Prevention Cheat Sheet/Шпаргалка по предотвращению XSS (межсайтового скриптинга)

* 👉 https://www.owasp.org/index.php/XSS_(Cross_Site_Scripting)_Prevention_Cheat_Sheet

###### DOM based XSS Prevention Cheat Sheet/Шпаргалка по предотвращению XSS на основе DOM

* 👉 https://www.owasp.org/index.php/DOM_based_XSS_Prevention_Cheat_Sheet

###### Testing for Reflected Cross site scripting (OTG-INPVAL-001)/Тестирование на отраженный межсайтовый скриптинг (OTG-INPVAL-001)

* 👉 https://www.owasp.org/index.php/Testing_for_Reflected_Cross_site_scripting_(OTG-INPVAL-001)

###### Testing for Stored Cross site scripting (OTG-INPVAL-002)/Тестирование хранимого межсайтового скриптинга (OTG-INPVAL-002)

* 👉 https://www.owasp.org/index.php/Testing_for_Stored_Cross_site_scripting_(OTG-INPVAL-002)

###### Testing for DOM-based Cross site scripting (OTG-CLIENT-001)/Тестирование межсайтового скриптинга на основе DOM (OTG-CLIENT-001)
...
###### Cross-Site Scripting (XSS) Cheat Sheet | Veracode/Шпаргалка по межсайтовым сценариям (XSS) | Veracode

* 👉 https://www.veracode.com/security/xss

#### Recommended books/Рекомендуемые книги :

* [XSS Attacks: Cross-site Scripting Exploits and Defense/XSS-атаки: Эксплойты межсайтового скриптинга и защита от них](https://books.google.com.tr/books/about/XSS_Attacks.html?id=dPhqDe0WHZ8C)

* [XSS Cheat Sheet/Шпаргалка по XSS](https://leanpub.com/xss)
